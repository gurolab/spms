    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addForm" action="../administrator/supply_receive-actions.php?action=add" method="post">
...
<div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editForm" action="../administrator/supply_receive-actions.php?action=update" method="post">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="deleteForm" action="../administrator/supply_receive-actions.php?action=del" method="post">
