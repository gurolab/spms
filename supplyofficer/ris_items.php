    ...
    <div class="dashboard-body">
        ...
        <div class="breadcrumb-with-buttons mb-24 flex-between flex-wrap gap-8">
            ...
            <div class="flex-align gap-8 flex-wrap">
                ...
                <?php if ($selectedRIS): ?>
                <a href="../administrator/print/ris.php?id=<?= (int)$selectedRIS['id'] ?>"
                   target="_blank"
                   class="btn-action"
        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <form id="inlineAddItemForm" action="../administrator/ris-actions.php?action=addrisitem" method="post"
                ...
                <table id="dtable" class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-gray-900">
                                <?php if ($canAddItems) : ?>
                                <form action="../administrator/ris-actions.php?action=delrisitem" method="post" onsubmit="return confirm('Are you sure you want to delete this item?');">
