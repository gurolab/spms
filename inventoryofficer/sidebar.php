...
$moduleBase = $baseUrl . '/inventoryofficer/';
    ...
    <div class="sidebar-menu-wrapper overflow-y-auto scroll-sm">
        <div class="p-5 pt-5">
            <ul class="sidebar-menu">
                ...
                <li class="sidebar-menu__item has-dropdown<?= $isActive(['stock_cards.php', 'stockcard.php', 'slc.php', 'inventory_reconciliation.php', 'reconciliation.php']) ?>">
                    ...
                    <ul class="sidebar-submenu">
                        <li class="sidebar-submenu__item">
                            <a href="<?= $moduleBase ?>stock_cards.php" class="sidebar-submenu__link<?= $isActive('stock_cards.php') ?>">Stock Cards</a>
                        </li>
                        <li class="sidebar-submenu__item">
                            <a href="<?= $moduleBase ?>slc.php" class="sidebar-submenu__link<?= $isActive('slc.php') ?>">Supply Ledger Card (SLC)</a>
                        </li>
                        <li class="sidebar-submenu__item">
                            <a href="<?= $moduleBase ?>inventory_reconciliation.php" class="sidebar-submenu__link<?= $isActive(['inventory_reconciliation.php', 'reconciliation.php']) ?>">Inventory Reconciliation</a>
                        </li>
                    </ul>
                </li>
