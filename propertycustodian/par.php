                        ...
                        <tr>
                            ...
                            <td class="text-gray-900">
                                <div class="d-flex gap-2 flex-wrap justify-content-center">
                                    ...
                                    <a href="../administrator/print/par.php?id=<?= $row['id'] ?>" target="_blank" class="btn-action"
...
$(document).ready(function() {
    ...
    $('#addModal').on('shown.bs.modal', function() {
        ...
        const $issuedBy = $('#add_issued_by');
        if ($issuedBy.find(`option[value="${currentUserId}"]`).length) {
            $issuedBy.val(String(currentUserId)).trigger('change');
        }
    });
