                    ...
                    <tbody>
                        <?php foreach ($issuanceList as $issuance): ?>
                            ...
                            <tr>
                                ...
                                <td class="text-gray-900"><?= !empty($issuance['remarks']) ? htmlspecialchars($issuance['remarks']) : '—' ?></td>
                                <td class="text-gray-900">
                                    <div class="d-flex gap-2 flex-wrap justify-content-center">
                                        ...
                                        <a href="print/rsmi.php?id=<?= $issuance['id'] ?>" target="_blank"
                                           class="btn-action"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addForm" action="supply_issuance-actions.php?action=add" method="post">
...
<div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editForm" action="supply_issuance-actions.php?action=update" method="post">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="deleteForm" action="supply_issuance-actions.php?action=del" method="post">
