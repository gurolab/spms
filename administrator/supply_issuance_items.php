...
<div class="dashboard-main-wrapper">
    <div class="dashboard-body">
        ...
        <div class="breadcrumb-with-buttons mb-24 flex-between flex-wrap gap-8">
            <div class="breadcrumb mb-24">
                <ul class="flex-align gap-4">
                    <li><a href="supply_issuance.php" class="text-gray-200 fw-normal text-15 hover-text-main-600">Issuances</a></li>
            ...
            <div class="flex-align gap-8 flex-wrap">
                <a href="print/rsmi.php?id=<?= (int)$issuance['id'] ?>" target="_blank"
                   class="btn-action"
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="supply_issuance-actions.php?action=addissuanceitem" method="post" class="row g-3 align-items-end">
                        ...
                        <?php if (!empty($issuanceItems)): ?>
                            <?php foreach ($issuanceItems as $row): ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-gray-900">
                                        <form action="supply_issuance-actions.php?action=delissuanceitem" method="post" onsubmit="return confirm('Remove this issued item?');">
                                            <input type="hidden" name="issuance_id" value="<?= $issuance_id ?>">
