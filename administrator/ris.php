                        ...
                        <tr>
                            ...
                            <td class="text-gray-900">
                                <div class="d-flex gap-2 flex-wrap justify-content-center">
                                    ...
                                    <a href="print/ris.php?id=<?= $r['id'] ?>" target="_blank"
                                       class="btn-action"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="addForm" action="ris-actions.php?action=initadd" method="post">
                    <div class="row mb-3">
                        <div class="col-md-6">
...
<div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editForm" action="ris-actions.php?action=update" method="post">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="deleteForm" action="ris-actions.php?action=del" method="post">
