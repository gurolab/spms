    ...
    <div class="dashboard-body">
        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <form id="inlineAddItemForm" action="supply_receive-actions.php?action=addreceiveitem" method="post"
                ...
                <table id="dtable" class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-gray-900">
                                <form action="supply_receive-actions.php?action=delreceiveitem" method="post" onsubmit="return confirm('Are you sure you want to delete this item?');">
